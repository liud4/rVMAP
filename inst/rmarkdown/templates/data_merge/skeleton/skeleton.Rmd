...
MAP ID 163 has a set of variables invalidated due to the presence of a cyst.
...
In this section, we will run scripts to invalidate variables for certain individuals as requested by VMAC.
