...
## base directories
box.dir  <- file.path("~", "OneDrive - VUMC")
...
composite.df <- readRDS(file.path(data.raw.dir, "np_composite_20230608.rds"))
####                                                    ####
##%######################################################%##
...
```{r biospecimen}
biospecimen.df <- process_biospecimen_availability(path = file.path(data.raw.dir, "old", "VMAP_biospecimens_collected_20210719.xlsx"), epoch = 1L:5L)
