...
# write.csv(variables_with_contradicting_labels_on_REDCap.df, 
#           file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103/", 
...
variables_without_labels.df <- data.frame(variable = names(merged.df)[names(merged.df) %nin% labels.df$field_name], stringsAsFactors = FALSE)

# write.csv(variables_without_labels.df, 
#           file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103/", 
#                            paste0("variables_without_labels_before_derivation",
#                                   "_d",
#                                   data.freeze.date,
#                                   "_m",
#                                   "20181219",
...
for (vname in baseline_vars) {
  label(epoch1ToRepeat[[vname]]) <- paste0(label(to_repeat.df[[vname]]), ", from Enrollment")
}
...
write.csv(e1.diff, file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103", paste0("e1_diff", current.data.merge.suffix, ".csv")), row.names = FALSE)
...
write.csv(e2.diff, file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103", paste0("e2_diff", current.data.merge.suffix, ".csv")), row.names = FALSE)
...
write.csv(e3.diff, file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103", paste0("e3_diff", current.data.merge.suffix, ".csv")), row.names = FALSE)
...
write.csv(e4.diff, file = file.path("/Users/khanoa/box/VMAC BIOSTAT/DATA/MAP/code/mergeDeriveLabel/d20181219_m20190103", paste0("e4_diff", current.data.merge.suffix, ".csv")), row.names = FALSE)
