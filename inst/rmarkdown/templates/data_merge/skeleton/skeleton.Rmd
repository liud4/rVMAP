...
merged.df$apoe4pos.factor <-  factor(merged.df$apoe4pos.factor, levels = c("No", "Yes"))

merged.df$diagnosis.factor.base <-  factor(merged.df$diagnosis.factor.base, levels = c("Normal", "Ambiguous At Risk", "MCI", "Dementia"))
