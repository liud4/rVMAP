...
## base directories
box.dir  <- file.path("C:", "Users", "zhanp15", "Box")
...
### Check duplicated map_id and epoch
...
lapply(seq_along(neuroimaging.list), function(i){check_duplicate_neuroimaging(neuroimaging.list[[i]],
                                                                          names(neuroimaging.list)[i])})
```
