...
if (download == TRUE) {
...
} else if (download == FALSE & is.null(data.freeze.date)) {
  ...
  stop("Either `download` or `data.freeze.date` must be specified as TRUE or FALSE and a 8 digit yyyymmdd, respectively.")
}
