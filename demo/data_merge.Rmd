...
Explain what the different variables are here.

## Epoch Independent

Add description for what Epoch Independent means.
...
mergeWithinEpoch_new(
  epochnum     = 1,
  mainfile     = MAPfreeze.list$epoch_1$data$main,
  functiondir  = function.dir,
  firstRds     = epoch1.rds,
  abpfile      = MAPfreeze.list$epoch_1$data$abp.static,
  biomarkfile  = MAPfreeze.list$epoch_1$data$biomarkers,
  auto3Tfile   = MAPfreeze.list$epoch_1$data$auto3T,
  auto3TBHfile = MAPfreeze.list$epoch_1$data$auto3T.bh,
  man3Tfile    = MAPfreeze.list$epoch_1$data$man3T,
  man3TBHfile  = MAPfreeze.list$epoch_1$data$man3T.bh,
  qmassfile    = MAPfreeze.list$epoch_1$data$cardiac.mri,
  addendumfile = MAPfreeze.list$epoch_1$data$addendum,
  csffile      = MAPfreeze.list$epoch_1$data$csf,
  srtfile      = MAPfreeze.list$epoch_1$data$srt.static
)
```
...
mergeWithinEpoch_new(
  epochnum     = 2,
  mainfile     = MAPfreeze.list$epoch_2$data$main,
  functiondir  = functiondir,
  firstRds     = epoch2.rds,
  # abpfile      = abpfileEpoch2,
  biomarkfile  = MAPfreeze.list$epoch_2$data$biomarkers,
  auto3Tfile   = MAPfreeze.list$epoch_2$data$auto3T,
  # auto3TBHfile = auto3TBHfileEpoch2,
  man3Tfile    = MAPfreeze.list$epoch_2$data$man3T,
  # man3TBHfile  = man3TBHfileEpoch2,
  qmassfile    = MAPfreeze.list$epoch_2$data$cardiac.mri,
  # addendumfile = addendumfileEpoch2,
  csffile      = MAPfreeze.list$epoch_2$data$csf
...
mergeWithinEpoch_new(
  epochnum     = 3,
  mainfile     = MAPfreeze.list$epoch_3$data$main,
  functiondir  = functiondir,
  firstRds     = epoch3.rds,
  # abpfile      = abpfileEpoch3,
  biomarkfile  = MAPfreeze.list$epoch_3$data$biomarkers,
  auto3Tfile   = MAPfreeze.list$epoch_3$data$auto3T,
  # auto3TBHfile = auto3TBHfileEpoch3,
  man3Tfile    = MAPfreeze.list$epoch_3$data$man3T,
  # man3TBHfile  = man3TBHfileEpoch3,
  # qmassfile    = qmassfileEpoch3,
  # addendumfile = addendumfileEpoch3,
  csffile      = MAPfreeze.list$epoch_3$data$csf
...
Move to after raw data labeling.
