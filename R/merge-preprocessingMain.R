...
preprocessingMain <- function(dat){
    ...
    dat[, numericCols] <- apply(dat[, numericCols], 2,
        minus9999)
    ...
    dat[, colsFor2222] <- apply(dat[, colsFor2222], 2,
        minus2222)
    ...
    dat[, colsFor8888] <- apply(dat[, colsFor8888], 2,
        minus8888)
    ...
    dat[, ecogself_underscore] <- apply(dat[, ecogself_underscore], 2,
        zeroNA)
