...
#'
#' @param dat A data frame containing the merged data set.
#' @return The merged data set with added labels and factor levels.
#' @export

mainLabelsAndFactors <- function(dat) {

  # OAK 20180814: Check if these labels are comprehensive for the merged data set.
  ...
  dat$sex.factor = factor(dat$sex,levels=c("1","2"))
  ...
  levels(dat$sex.factor)=c("Male","Female")
  ...
  dat$diagnosis.factor <- factor(
    dat$diagnosis.factor,
