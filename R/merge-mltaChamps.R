...
mltaChamps <- function(dat) {
  ...
  dat <- within(dat, {
    ...
    mlta01.kcal <- as.numeric(mlta01) * 3.5
    mlta02.kcal <- as.numeric(mlta02) * 4.5
    mlta03.kcal <- as.numeric(mlta03) * 5.0
    mlta04.kcal <- as.numeric(mlta04) * 2.5
    mlta05.kcal <- as.numeric(mlta05) * 4.5
    mlta06.kcal <- as.numeric(mlta06) * 6.0
    mlta07.kcal <- as.numeric(mlta07) * 4.0
    mlta08.kcal <- as.numeric(mlta08) * 4.5
    mlta09.kcal <- as.numeric(mlta09) * 5.0
    mlta10.kcal <- as.numeric(mlta10) * 6.0
    mlta11.kcal <- as.numeric(mlta11) * 4.0
    mlta12.kcal <- as.numeric(mlta12) * 5.5
    mlta13.kcal <- as.numeric(mlta13) * 5.5
    mlta14.kcal <- as.numeric(mlta14) * 4.5
    mlta15.kcal <- as.numeric(mlta15) * 6.0
    mlta16.kcal <- as.numeric(mlta16) * 3.0
    mlta17.kcal <- as.numeric(mlta17) * 3.5
    mlta18.kcal <- as.numeric(mlta18) * 5.0
    mlta19.kcal <- as.numeric(mlta19) * 5.5
    mlta20.kcal <- as.numeric(mlta20) * 8.0
    mlta21.kcal <- as.numeric(mlta21) * 6.0
    mlta22.kcal <- as.numeric(mlta22) * 7.0
    mlta23.kcal <- as.numeric(mlta23) * 3.0
    mlta24.kcal <- as.numeric(mlta24) * 6.0
    mlta25.kcal <- as.numeric(mlta25) * 6.0
