...
invalidNeuropsychItems <- function(dat){
    x <- c(
    "np.tower01"         ,       "np.tower02"               ,
    "np.tower03"         ,       "np.tower04"               ,
    "np.tower05"         ,       "np.tower06"               ,
    "np.tower07"         ,       "np.tower08"               ,
    "np.tower09"         ,       "np.tower.items"           ,
    "np.tower.ruleviol"  ,       "np.tower.ruleviol.cumperc",
    "np.tower"           ,       "np.tower.ss"     )
	...
	x4 <- c(
		"np.cvltrec.hits",        		  "np.cvltrec.hits.z",             
 		"np.cvltrec.falsepos",            "np.cvltrecog.falsepos.z",       
 		"np.cvltrecog.discrim",           "np.cvltrecog.discrim.z",        
 		"np.cvltrecog.sourcediscrim",     "np.cvltrecog.sourcediscrim.z",  
 		"np.cvltrecog.semanticdiscrim",   "np.cvltrecog.semanticdiscrim.z",
 		"np.cvltrecog.noveldiscrim",      "np.cvltrecog.noveldiscrim.z",   
 		"np.cvltrecog.responbias",        "np.cvltrecog.responbias.z"
 		)
  ...
  #
	...
	calc.e3.vars <- data.frame(
	  meta.epoch3[meta.epoch3$field_type == "calc",
