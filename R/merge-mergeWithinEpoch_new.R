...
mergeWithinEpoch_new <- function(epochnum, mainfile, 
    ...
    if(!is.null(addendumfile)){
        ...
        #addendumdat <- read.csv(addendumfile, stringsAsFactors=  FALSE)
