...
mainLabelsAndFactors <- function(dat) {
    ...
    label(dat$famhx.firstdegree.ptp)="Total # of first-degree family members with significant memory problems"
    label(dat$famhx.any.ptp)="Total # of all family members with significant memory problems"
    ...
    label(dat$famhx.firstdegree.inf)="Total # of first-degree family members with significant memory problems"
    label(dat$famhx.any.inf)="Total # of all family members with significant memory problems"
    ...
    label(dat$ccqself)="CCQ Self - Total Score"
    label(dat$ccqself.short)="CCQ Self - Short Total Score"
    ...
    label(dat$cogdif)="CogDiff - Total Score"
    ...
    label(dat$mfq.freqforget)="MFQ - General Frequency of Forgetting Total"
    label(dat$mfq.freqforget.avg)="MFQ - General Frequency of Forgetting Average"
    label(dat$mfq.seriousforget)="MFQ - Seriousness of Forgetting Total"
    label(dat$mem.seriousforget.avg)="MFQ - Seriousness of Forgetting Average"
    label(dat$mem.retro)="MFQ - Retrospective Functioning Total"
    label(dat$mem.retro.avg)="MFQ - Retrospective Functioning Average"
    label(dat$mem.mnemonics)="MFQ - Mnemonics Usage Total"
    label(dat$mem.mnemonics.avg)="MFQ - Mnemonics Usage Average"
    label(dat$mfq)="MFQ - Total Score"
    ...
    label(dat$ecogself.attn04)="ECog Self - Att 4 - Cooking or working and talking at the same time"
    label(dat$ecogself)="ECog Self - Total Score"
    label(dat$ecogself.prorate)="ECog Self - Prorated Total"
    label(dat$ecogself.mem)="ECog Self - Memory Total"
    label(dat$ecogself.lang)="ECog Self - Language Total"
    label(dat$ecogself.vis)="ECog Self - Visuospatial Total"
    label(dat$ecogself.plan)="ECog Self - Planning Total"
    label(dat$ecogself.org)="ECog Self - Organization Total"
    label(dat$ecogself.attn)="ECog Self - Attention Total"
    ...
    label(dat$fcadl)="FCADL Total Score"
    ...
    label(dat$food.percent.ener.fat)="Food - Percent Energy From Fat - Calculated in MATLAB"
    ...
    label(dat$mlta01.kcal)="MLTA 1 - Walking for pleasure or exercise (kcal)"
    label(dat$mlta02.kcal)="MLTA 2 - Chores: in the home (moderate) (kcal)"
    label(dat$mlta03.kcal)="MLTA 3 - Chores: outside (kcal)"
    label(dat$mlta04.kcal)="MLTA 4 - Mowing the lawn: rider mower (kcal)"
    label(dat$mlta05.kcal)="MLTA 5 - Mowing the lawn: walking behind power (kcal)"
    label(dat$mlta06.kcal)="MLTA 6 - Mowing the lawn: push mower (kcal)"
    label(dat$mlta07.kcal)="MLTA 7 - Raking the yard (kcal)"
    label(dat$mlta08.kcal)="MLTA 8 - Gardening: weeding /cultivation (kcal)"
    label(dat$mlta09.kcal)="MLTA 9 - Gardening: digging (kcal)"
    label(dat$mlta10.kcal)="MLTA 10 - Jogging (kcal)"
    label(dat$mlta11.kcal)="MLTA 11 - Biking for pleasure (kcal)"
    label(dat$mlta12.kcal)="MLTA 12 - Exercise cycling (kcal)"
    label(dat$mlta13.kcal)="MLTA 13 - Dancing (kcal)"
    label(dat$mlta14.kcal)="MLTA 14 - Aerobics: home (kcal)"
    label(dat$mlta15.kcal)="MLTA 15 - Aerobics: health club (kcal)"
    label(dat$mlta16.kcal)="MLTA 16 - Bowling (kcal)"
    label(dat$mlta17.kcal)="MLTA 17 - Golf: driving cart (kcal)"
    label(dat$mlta18.kcal)="MLTA 18 - Golf: walking /clubs on cart (kcal)"
    label(dat$mlta19.kcal)="MLTA 19 - Golf: walking and carrying clubs (kcal)"
    label(dat$mlta20.kcal)="MLTA 20 - Tennis singles (kcal)"
    label(dat$mlta21.kcal)="MLTA 21 - Tennis doubles (kcal)"
    label(dat$mlta22.kcal)="MLTA 22 - Racquet ball (kcal)"
    label(dat$mlta23.kcal)="MLTA 23 - Calisthenics (kcal)"
    label(dat$mlta24.kcal)="MLTA 24 - Swimming (kcal)"
    label(dat$mlta25.kcal)="MLTA 25 - Hiking (kcal)"
    label(dat$mlta.min)="MLTA Total Minutes"
    label(dat$mlta.kcal)="MLTA Total Kcal"
    ...
    label(dat$champs.caloricexpend.all)="CHAMPS Caloric Expenditure Per Week in all Activities"
    label(dat$champs.caloricexpend.mod)="CHAMPS Caloric Expenditure Per Week in Moderate Intensity Activities"
    label(dat$champs.freqall)="CHAMPS Frequency Per Week of all Activities"
    label(dat$champs.freqmod)="CHAMPS Frequency/Week of Moderate-Intensity Activities"
    ...
    label(dat$psqi.duration)="PSQI - Duration of Sleep"
    label(dat$psqi.disturb)="PSQI - Sleep Disturbance"
    label(dat$psqi.latency)="PSQI - Sleep Latency"
    label(dat$psqi.dysfx)="PSQI - Daytime Dysfunction due to Sleepiness"
    label(dat$psqi.efficiency)="PSQI - Sleep Efficiency"
    label(dat$psqi.quality)="PSQI - Overall Sleep Quality"
    label(dat$psqi.sleepmeds)="PSQI - Need Meds to Sleep"
    label(dat$psqi)="PSQI - Total Score"
    ...
    label(dat$qids)="QIDS Total Score"
    ...
    label(dat$bmi)="Physical Exam - BMI"
    label(dat$bsa)="Physical Exam - BSA"
    ...
    label(dat$echo.lvmass)="Echo - LV mass"
    label(dat$echo.lvmass.index)="Echo - LV mass index"
    ...
    label(dat$bld.c.egfr)="Clinical Blood - eGFR"
    label(dat$bld.c.egfraa)="Clinical Blood - eGFRAA"
    ...
    label(dat$bld.c.homair)="Clinical Blood - HOMA-IR (m/dL)"
    label(dat$insulin.resist)="Clinical Blood - Insulin resistance"
    ...
    label(dat$np.tower)="DKEFS Tower total raw score"
    ...
    label(dat$np.anim.err)="Animal Naming - errors"
    ...
    label(dat$np.anim)="Animal Naming - total score"
    ...
    label(dat$np.tmt.contrastdiff)="Trails B vs A contrast difference"
    ...
    label(dat$np.biber.t1to5)="Biber total immediate recall"
    ...
    label(dat$np.gds)="GDS total score"
